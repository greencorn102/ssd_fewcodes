...
parser.add_argument('--datasets', '--data', nargs='+', default=["data_new"], help='Dataset directory path') ### Data Folder
...
parser.add_argument('--num-epochs', '--epochs', default=5, type=int,
...
def test(loader, net, criterion, device):
    ...
    for _, data in enumerate(loader):
        ...
        running_regression_loss += regression_loss.item()
        running_classification_loss += classification_loss.item()
    return running_loss , running_regression_loss , running_classification_loss# / num
